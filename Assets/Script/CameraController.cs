...
public class CameraController : MonoBehaviour {
    ...
    {
        if(Mathf.Abs(m_actorController.InputDetecter.RightKey_Vertical) > 0)
        {
            m_cameraHandleTempEulerAngles_x += m_actorController.InputDetecter.RightKey_Vertical * -m_rotateSpeed_vertical * Time.deltaTime;
